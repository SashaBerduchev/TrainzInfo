...
{
    public class TypeOfPassTrainsController : BaseController
    {
        private readonly ApplicationContext _context;

        public TypeOfPassTrainsController(ApplicationContext context, UserManager<IdentityUser> userManager)
        : base(userManager)
        {
            _context = context;
        }
