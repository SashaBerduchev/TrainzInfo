...
namespace TrainzInfo.Controllers
{
    public class PassangerCarrieresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Calss,CountPlace,PlaceType")] PassangerCarriere passangerCarriere)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Calss,CountPlace,PlaceType")] PassangerCarriere passangerCarriere)
        {
